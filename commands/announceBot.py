...
class FAQtopics(Config):
    ...
    frequently_asked_questions = {
        ...
        'bug': "Thanks for wanting to report a bug! All of the info you need to report a bug can be found in <#479107323139457027>.",
        'badge': "**Oooo... shiny! I want a badge! How do I get this badge?**\n"
            + "It's only available for Bug Hunters. We occasionally run BH only events where one of the prizes for outstanding participation (read: top placing) will be the Bug Hunter Badge. It also may be a reward for new <#274590523719811074> as well.\n"
            ...
            + "Bug Hunters have access to an XP system where when they perform helpful actions (like approving or denying a bug) they get a certain number of points. They can then spend these points on real rewards, like hoodies, t-shirts and even the Bug Hunter Badge.",
        'hypesquad': "**What is HypeSquad??** \nIt is one of Discord\'s Community Programs where members show their excitement towards Discord. You can check out the website here: <https://discordapp.com/hypesquad> \n"
            ...
            + "\n**How do I join?** \n"
            + "Anyone can join HypeSquad by opening their User Settings > HypeSquad and following the instructions there. \n"

...
class TrelloConfig(AnnounceBotConfig):
    ...
    eng_emoji = ["🤙", ":NABbutton:304643220581646336", ":CNRbutton:341981653469495306", ":fixed:517143837991501835"]
    member_dict = {
    ...
    list_dict = {
        ...
        '57f2a306ca14741151990900': {  # Android
            "NABbutton": '5b0609fc06bd61f148dc5293',
            "CNRbutton": '58064b37e4c51a85d6d0b68e',
            "fixed": '58d178ec961e15df2e742cb7',
            "Verified Bugs": '57fe7f78ddde6b37323bd670'
        },
        '57f2d333b99965a6ba8cd7e0': {  # iOS
            "NABbutton": '57f2a37248089a5e6a0bf9b6',
            "CNRbutton": '580e8083de3bfbcd4de2ecb9',
            "fixed": '57f3de4a5e37d8142fde0313',
            "Verified Bugs": '57fe7f909aa7fe383d56406b'
        },
        '5771673855f47b547f2decc3': {  # Desktop
            "NABbutton": '580e822c24ce2ffdd624a43c',
            "CNRbutton": '5771678de6092759049c939f',
            "fixed": '581286a2c1e6cd4831c862ca',
            "Verified Bugs": '57716787a06d09cf7e0dd1ca'
        },
        '5bc7b4adf7d2b839fa6ac108': {  # Store
            "NABbutton": '5bce410f7bbb6343675cb496',
            "CNRbutton": '5bf4c065c59169111a5aff6e',
            "fixed": '5bce3dcf8098df6e897bc707',
...
class TrelloPlugin(BasePlugin):
    ...
    def on_message(self, event):
        if event.channel.id == self.config.eng_channel and event.author.id == self.state.me.id:
